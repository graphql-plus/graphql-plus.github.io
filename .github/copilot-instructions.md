...
- Review the output of `convert.ps1` carefully. It runs `dprint fmt`, regenerates sample markdown, and performs PEG validation, so it can surface unrelated churn if a change was too broad.
