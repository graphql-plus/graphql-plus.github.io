...
- Review the output of `convert.ps1` carefully. It runs `biome format --write .`, regenerates sample markdown, and performs PEG validation, so it can surface unrelated churn if a change was too broad.
